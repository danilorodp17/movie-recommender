...
class MovieRecommender:
    ...
    def carregar_modelo(self):
        model_path = DATA_DIR / "models" / "svd_model.pkl"
        ...
        if model_path.exists():
            ...
            print("⚠️ Modelo não encontrado — recomendações por IA apenas")
            self.loaded = False
    ...
    def buscar_filmes(self, query: str, n: int = 10):
        ...
        return self.movies[mask].head(n).to_dict(orient="records")
